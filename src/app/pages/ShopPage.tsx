...
import shopHeroImage from 'figma:asset/d57cdca6fd40b75203c33e78dffacd20f4175fc8.png';
import shopHeroImageMobile from 'figma:asset/3a74539b273495185fd1bd4324da22c3f1ca7f98.png';
...
export function ShopPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Premium Hero Banner with Full-Width Background Image */}
      <section className="relative -mt-32 pt-48 pb-20 md:-mt-36 md:pt-56 md:pb-32 lg:pb-40 xl:pb-48 overflow-hidden min-h-[280px] md:min-h-[800px]">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-black/15 to-black/35 md:from-black/30 md:via-black/20 md:to-black/40"></div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10 mt-24 md:mt-16">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              Curated selection of stunning colored contact lenses designed for 
              effortless beauty, all-day comfort, and mesmerizing looks
            </motion.p>
        ...
        <div className="max-w-[1440px] mx-auto">
          <div 
            className="
              ...
              shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.8)] 
          ...
          >
            <div className="flex gap-4 md:gap-8 overflow-x-auto pb-2 scrollbar-hide">
              {categories.map((category) => (
                <motion.button
                  ...
                  className="relative text-xs tracking-wider whitespace-nowrap pb-2 transition-colors"
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <span className={activeCategory === category ? 'text-black' : 'text-black/40'}>
                    {category}
                  </span>
            ...
            {/* Scroll indicator gradient - only visible on mobile */}
