  ...
  const faqs = [
    {
      ...
      answer: 'Daily disposables can be worn for up to 12-14 hours, while monthly lenses typically allow 10-12 hours of comfortable wear. However, individual comfort varies. If you experience dryness or discomfort, reduce wearing time and give your eyes a break. Never exceed the manufacturer\'s recommended wearing schedule, and always remove lenses before sleeping unless specifically prescribed for extended wear.'
    },
    {
      question: 'Can I swim or shower with contact lenses?',
      answer: 'It\'s not recommended to swim or shower while wearing contact lenses. Water can introduce bacteria and microorganisms that may cause serious eye infections. If you must swim with lenses, wear watertight goggles and use daily disposables that you can throw away immediately after. For showers, keep your eyes closed or remove lenses beforehand.'
    },
    {
      question: 'What should I do if a lens gets stuck in my eye?',
      answer: 'Don\'t panic—lenses cannot get lost behind your eye. First, try using rewetting drops to lubricate your eye, then gently massage your closed eyelid. Look in the opposite direction of where you feel the lens. If you still can\'t locate it, it may have already fallen out. If discomfort persists or you can\'t remove the lens, contact your eye care professional.'
    },
    {
      question: 'How often should I replace my contact lens case?',
      answer: 'Replace your contact lens case every 3 months, or sooner if it becomes damaged or difficult to clean. Cases harbor bacteria over time, even with proper cleaning. Some eye care professionals recommend replacing cases monthly for optimal hygiene. Always clean your case daily with solution (never water) and let it air dry upside down.'
    },
    {
      question: 'Can I use any brand of contact lens solution?',
      answer: 'Not all solutions are compatible with all lenses. Always use the solution recommended by your eye care professional or the lens manufacturer. Some lenses require specific solutions for optimal performance and eye health. Mixing different solution brands or using expired products can cause discomfort or damage to your lenses.'
    },
    {
      question: 'When should I see an eye doctor about my contacts?',
      answer: 'Schedule annual eye exams even if your vision seems fine. See your eye doctor immediately if you experience: persistent redness, pain, excessive tearing, unusual discharge, sudden vision changes, light sensitivity, or any symptoms that don\'t resolve after removing your lenses. Early intervention prevents serious complications.'
    }
  ];

  const quickTips = [
    { icon: ThumbsUp, tip: 'Always handle lenses with clean, dry hands', color: 'bg-black' },
    { icon: Clock, tip: 'Never wear lenses longer than recommended', color: 'bg-black' },
    { icon: Droplets, tip: 'Use fresh solution every time—never reuse', color: 'bg-black' },
    { icon: Moon, tip: 'Remove lenses before sleeping (unless approved)', color: 'bg-black' },
    { icon: Sun, tip: 'Consider UV-blocking lenses for sun protection', color: 'bg-black' },
    { icon: Calendar, tip: 'Mark your calendar for replacement dates', color: 'bg-black' },
  ];
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 border border-white/20 rounded-full backdrop-blur-sm">
              ...
              <span className="text-xs tracking-widest text-white/70">EXPERT KNOWLEDGE</span>
            </div>
          </motion.div>
      ...
      <section className="py-20 md:py-32 bg-black text-white">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl mb-6">Ready to Find Your Perfect Lenses?</h2>
